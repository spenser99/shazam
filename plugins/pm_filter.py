...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️🇲 🇴 🇻 🇮 🇪 🇸 ⚔️', url='https://t.me/casinova65') ] ] )
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await client.send_cached_media(
                    ...
                    file_id=file_id,
                    caption=f_caption,
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️🇲 🇴 🇻 🇮 🇪  🇸 ⚔️', url='https://t.me/casinova65') ] ] ),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋', url='https://t.me/casinova65')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('🤖 𝖴𝗉𝖽𝖺𝗍𝖾𝗌', url='https://t.me/casinova65'),
